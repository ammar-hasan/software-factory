...
REPOSITORY = "https://github.com/ammar-hasan/software-factory"
...
.pending { color: var(--dim); font-size: 0.88em; }
a { color: var(--accent); }
...
def link(href: str) -> str:
    ...
    if inside:
        ...
        return html.escape(f"{REPOSITORY}/{where}/main/{inside}{suffix}")
...
<a class="cta" href="{REPOSITORY}">GitHub</a>
</div>
...
def shell(page: Page, body: str, headings: list[Heading], pages: tuple[Page, ...]) -> str:
    ...
    nav.append(f'<a class="external" href="{REPOSITORY}">Source</a>')
